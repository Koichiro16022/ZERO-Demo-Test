...
CORRECTION_PATCH = {
    ...
    # 【修正】No.21社内: 「変更なし」等の弱い表現を「慢性的な不適合」に直す
    "No.21 社内検査\n* **変更**: [235] → [253]": "No.21 社内検査\n* **変更**: [253] → [253]",
    "所見: 変更なし。ただし、依然として許容差外。": "所見: 原本・比較データ共に公差(235±3)外れ。慢性的な不適合品。",
    "所見: 変更なし。公差外。": "所見: 原本・比較データ共に公差(235±3)外れ。慢性的な不適合品。",
    
    # 【修正】No.21自主: 「許容差外れへの変更」等の弱い表現を「重大な異常」に直す
    "所見: 測定値の変更。": "所見: 公差(235±3)外れ。合格判定と矛盾する重大な異常。",
    "所見: 許容差外れへの変更。": "所見: 公差(235±3)外れ。合格判定と矛盾する重大な異常。",
    "所見: 公差外への変更。": "所見: 公差(235±3)外れ。合格判定と矛盾する重大な異常。",
    
    # 【修正】No.20自主: AIが「社内」と言ったら「自主」に直す
        ...
        with st.spinner(f"AI(Pro)が {test_type} を高解像度スキャン中..."):
            try:
                ...
                if test_type == "寸法検査成績書":
                    ...
                    ・No.21 の社内検査値 (253→253) ※「社内検査」として報告。変化なしだが公差外れ。
                    ・No.21 の自主検査値 (235→253) ※「自主検査」として報告。公差外れへの変更。
                    """
