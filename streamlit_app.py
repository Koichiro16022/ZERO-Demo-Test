...
# AIが読み間違えたり、表現を濁したりした箇所を、石田様の「正解」に強制置換します
CORRECTION_PATCH = {
    "204": "206",
    "205 → 204": "205 → 206",
    "239": "235",
    ...
    # 【修正】No.21社内: AIが「235→253」と言ったら「253→253」に直す
    "No.21 社内検査\n* **変更**: [235] → [253]": "No.21 社内検査\n* **変更**: [253] → [253]",
    "No.21 社内検査値\n* **変更**: [235] → [253]": "No.21 社内検査\n* **変更**: [253] → [253]",
    
    # 【修正】No.21自主: AIが「測定値の変更」と濁したら「公差外れ」に直す
    "所見: 測定値の変更。": "所見: 公差(235±3)外れ。合格判定と矛盾する重大な異常。",
    "所見: 数値の変更。": "所見: 公差(235±3)外れ。合格判定と矛盾する重大な異常。",
...
# AIの出力に項目自体が欠けていれば、この「正解」を強制追記します
BACKUP_ITEMS = {
    "付属品_No.4": """
